import copy
# CS 4395.001 - Assignment 6: Web Crawler
...
def webCrawler(ogLink):
    ...
    # Crawl through links to find 15 relevant ones, with some outside original domain.
    linksFound = 0
    linksCrawled = 0
    ...
    while True:
        ...
        for link in soup.find_all('a'):
            ...
            # Get links related to topic; i.e, Evangelion
            if 'Evangelion' in link_string or 'evangelion' in link_string:
...
def getTermFrequency(fileName, freqDict):
    ...
    # Get term frequency of all (non-stop) words found in the documents
...
if __name__ == '__main__':
    ...
    urlList = webCrawler("https://en.wikipedia.org/wiki/Neon_Genesis_Evangelion")
    print("")
