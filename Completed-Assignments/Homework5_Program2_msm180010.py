...
if __name__ == '__main__':
    ...
    # Calculate probability of language:
    ...
    for line in rawText_test.splitlines():
        ...
        # Find which language each line is most likely in (with laplace smoothing).
        # Bigram Prob. = (b+1)/(u+v); b = bigram count, u = unigram count, v = vocab size (length of all unigram dictionaries)
    ...
    print("\nTotal Correct Cases: " + str(correctCases) + " / 300 = " + str(round(((correctCases/count)*100), 3)) + "%\n")
